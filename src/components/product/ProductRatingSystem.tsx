    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 bg-white rounded-xl shadow-md border border-gray-100">
        <div className="flex flex-col items-center justify-center space-y-3 p-4 bg-primary/5 rounded-lg">
          <div className="text-5xl font-bold text-primary text-left">
        ...
        <div className="col-span-2 space-y-4 p-4">
          {[5, 4, 3, 2, 1].map((stars, index) => (
            <div key={stars} className="flex items-center gap-4">
              <span className="w-16 text-sm font-medium text-gray-600 text-left">
                {stars} stars
              </span>
              <Progress
                value={
              ...
              />
              <span className="w-12 text-sm text-gray-600 font-medium text-left">
                {ratingStats.rating_distribution[index]}
              </span>
            </div>
          ))}
              ...
              <div className="space-y-4">
                {userReviews.map((review) => (
                  ...
                  >
                    ...
                    <p className="text-gray-700 text-left">{review.review_text}</p>
                  </div>
                ))}
              </div>
            </ScrollArea>
